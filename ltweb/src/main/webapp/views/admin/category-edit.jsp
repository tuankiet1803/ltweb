...
<form action="/ltweb/admin/category/update" method="post" enctype="multipart/form-data">
  <input type="text" id="catename" name="cateid" value="${cate.id}" hidden="hidden"><br>
  <label for="catename">Category Name:</label><br>
  <input type="text" id="catename" name="catename" value="${cate.name }"><br>
