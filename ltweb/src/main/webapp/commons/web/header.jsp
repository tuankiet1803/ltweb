        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 additional-nav">
                <ul class="list-unstyled list-inline pull-right">
                    ...
                    <c:otherwise>
                     <a href="${pageContext.request.contextPath }/home">${sessionScope.account.fullName }</a>
...
<div class="header">
  <div class="container">
    <a class="site-logo" href="/ltweb/home"><img src="${URL}assets/frontend/layout/img/logos/logo-shop-red.png" alt="Metronic Shop UI"></a>
